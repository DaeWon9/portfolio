  ...
  let projectData = [
    {
      ...
      image: (
        <>
          ...
          >
            <img
              src={convenienceStroeImage.start}
              width="60%"
              height="88%"
            ></img>
          </SwiperSlide>
          ...
          >
            <img
              src={convenienceStroeImage.noodle}
              width="60%"
              height="88%"
            ></img>
          </SwiperSlide>
          ...
          >
            <img
              src={convenienceStroeImage.snack}
              width="60%"
              height="88%"
            ></img>
          </SwiperSlide>
          ...
          >
            <img
              src={convenienceStroeImage.drink}
              width="60%"
              height="88%"
            ></img>
          </SwiperSlide>
      ...
      background: (
        <p>
          ...
          <strong>
            물건을 구매하는 과정에서 점자 표시 미흡으로 인한 시각장애인분들의
            불편함을 알게되었습니다.{" "}
          </strong>
          따라서 <strong>핸드폰 카메라를 활용</strong>하여 물건을 구매할 때{" "}
          <strong>어떤 물건인지 알려주는 서비스</strong>가 있으면 좋을 것 같다는
          생각에 기획하게 되었습니다.
        </p>
      ),
      takeAway: (
        <p>
          처음 진행했던 <strong>인공지능 어플리케이션 서비스</strong>인것
          만으로도 의미가 있었지만, <br />그 과정에서 <strong>"Aihub"</strong>의
          데이터셋과 <strong>"Roboflow"</strong>를 활용하여 인공지능 모델을
          학습시키기 위한 <strong>데이터셋을 구축</strong>하고,
          <strong>"Colab"</strong>환경에서 직접 학습시킨 모델을 안드로이드에
          탑재하여 사용해보는 값진 경험을 하였습니다.
          <br />
          또한 <strong>시작장애인분들의 편의성을 위한 UX 구상</strong>에 많은
          공을 들인 프로젝트입니다.
        </p>
      ),
      service: (
        <>
          ...
          <p>
            <strong>
              ✤ <span style={{ color: "#ed3770" }}>카메라</span>를 활용하여
              실시간으로{" "}
              <span style={{ color: "#ed3770" }}>화면에 노출되어있는 물건</span>
              의 정보를 <span style={{ color: "#ed3770" }}>음성</span>으로 출력
            </strong>
          </p>
          <p>
            <strong>
              ✤ <span style={{ color: "#ed3770" }}>찾고자 하는 물건</span>이
              탐지될경우 <span style={{ color: "#ed3770" }}>음성</span>으로
              알려주는 기능
            </strong>
          </p>
          <p>
      ...
      background: (
        <p>
          <p>
            <strong>
              {
                "[2022 개방형 클라우드 플랫폼 기반 서비스 개발 공모전 특별상 수상작]"
              }
            </strong>
          </p>
          실제로 팀프로젝트를 진행하면서{" "}
          <strong>
            기존의 협업 툴을 이용시에 채팅 창에만 자료를 업로드할 수 있거나,
            진행사항이 정리된 공간이 따로 없어 진행사항을 파악하기에 어려움을
            느꼈습니다.
          </strong>
          <br />
          이에 <strong>프로젝트의 진행현황 및 파일을 효과적으로 관리</strong>할
          수 있는 기능을 탑재한다면, 팀 단위로 협업을 진행하는 분들에게 도움이
          될 것이라고 판단하여 개발을 추진하게 되었습니다.
        </p>
      ),
      takeAway: (
        <p>
          이번 프로젝트는 모든것이 처음이였던 프로젝트였습니다.
          <strong>React, MVVM 패턴, 웹소켓</strong> 등 처음부터 공부하면서
          진행했던 프로젝트라 더욱 의미가 있었습니다.
          <strong>React</strong>를 처음으로 사용해보면서 React가 가진 차별성을
          느낄 수 있었습니다. 특히 <strong>웹소켓</strong>을 통한 서버와
          클라이언트의 <strong>양방향 통신</strong>을 구현하면서, 실시간으로
          사용자들에게 보여주는 작업이 필요했습니다. 이때{" "}
          <strong>React 상태관리</strong>의 이점을 많이 느꼈습니다.
        </p>
      ),
      service: (
        <>
          <p>
            <strong>
              ✤ <span style={{ color: "#ed3770" }}>팀단위의 협업</span>을
              도와주는 웹 커뮤니티 서비스
            </strong>
          </p>
          <p>
            <strong>
              ✤ 간단한 조작으로{" "}
              <span style={{ color: "#ed3770" }}>협업공간</span>을{" "}
          ...
          <p>
            <strong>
              ✤ 중요한 자료를 따로 관리하는{" "}
              <span style={{ color: "#ed3770" }}>'버킷'</span>
            </strong>
          </p>
          <p>
            <strong>
              ✤ 한눈에 보는{" "}
              <span style={{ color: "#ed3770" }}>프로젝트 진행도</span>
            </strong>
          </p>
          <p>
            <strong>
              ✤ 몇 번의 클릭으로{" "}
              <span style={{ color: "#ed3770" }}>최종 결과물 취합</span>
            </strong>
          </p>
          <p>
            <strong>
    ...
    },
    {
      ...
      background: (
        <p>
          ...
          <strong>
            저희 팀은 장애인분들을 위한 서비스를 개발하고자 했습니다.
          </strong>{" "}
          여러 자료를 찾아보니,{" "}
          <strong>장애인분들의 우울증 수치가 비장애인에 비해 높게</strong>{" "}
          나타난다는 자료를 보게되었고.
          <strong>
            그림그리는 활동이 우울증 감소, 와 같은 정신적으로 긍정적
          </strong>
          인 효과가 있다는 사실 또한 알게되었습니다. 하지만,{" "}
          <strong>
            손을 사용하기 힘드신분들은 그림그리기에 제약사항이 많았고,
          </strong>{" "}
          이에 <strong>얼굴을 움직여 그림그리는 서비스</strong>를 제공하면 좋을
          것 같다는 생각에 추진하게되었습니다.
        </p>
      ),
      takeAway: (
        <p>
          손을사용하지 못하는 분들을 위한 서비스이기에, 얼굴의 움직임으로만 모든
          기능들을 사용할 수 있도록 하는 작업이 필요했습니다. 그 과정에서{" "}
          <strong>MediaPipe</strong>에서 제공하는 <strong>FaceMesh</strong>라는
          라이브러리를 사용하여 사용자의 얼굴데이터를 받아왔는데, 처음에는{" "}
          <strong>눈의 깜빡임</strong>으로 모든 기능들을 제어했었습니다.
          <br />
          실제로 손을사용하기 힘드신분들을 찾아가 저희 서비스에 대한 피드백을
          부탁드린결과, 개개인의 눈의 특성으로 인해 불편함을 호소하는 사용자가
          많았고 이로인해 <strong>입을 활용하는 모드</strong>를 추가하게
          되었습니다. 이를 통해 다양한 사용자의 특성을 고려해야한다는 점을 몸소
          느꼈고 더더욱 <strong>UX & UI</strong>구상에 공을 들인 프로젝트입니다.
        </p>
      ),
      service: (
        <>
          <p>
            <strong>
              ✤ 사용자의 <span style={{ color: "#ed3770" }}>얼굴데이터</span>를
              활용한 <span style={{ color: "#ed3770" }}>웹 드로잉</span> 서비스
            </strong>
          </p>
          <p>
            <strong>
              ✤ <span style={{ color: "#ed3770" }}>EyeMode & MouthMode</span>를
              제공하여 사용자가 편리한 방식으로 제어
            </strong>
          </p>
          <p>
            <strong>
              ✤{" "}
              <span style={{ color: "#ed3770" }}>
                눈과 입의 움직임으로 컨트롤
              </span>{" "}
              가능한 마우스 & 키보드 & 버튼
            </strong>
          ...
          <p>
            <strong>
              ✤ 다양한 <span style={{ color: "#ed3770" }}>그림그리기 도구</span>{" "}
              제공
            </strong>
          </p>
          <p>
          ...
          <p>
            <strong>
              ...
              <a
                target="_blank"
                href="https://github.com/Eyetist/Eyetist_Client"
              >
        ...
        <>
          <p>
            <strong>
              ...
              <a
                target="_blank"
                href="https://github.com/DaeWon9/OpenSourceProject"
              >
